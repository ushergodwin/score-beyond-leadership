...
const fetchOrder = async () => {
    try {
        ...
        // No token needed for logged-in users - authentication is handled by the backend
        ...
        <div class="container-fluid py-4 px-3 px-md-4">
            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
                <div>
                    ...
                    <h1 class="h3 fw-bold text-primary mb-2 mt-2">Track Order</h1>
                    <p class="text-muted mb-0">Order Number: <strong>{{ orderNumber }}</strong></p>
                </div>
            </div>
            ...
            <div v-else-if="error" class="card border-0 shadow-sm rounded-4 border-danger">
                <div class="card-body p-5 text-center">
                    ...
                    <div class="d-flex gap-2 justify-content-center">
                        ...
                        <Link :href="route('dashboard.orders')" class="btn btn-outline-secondary rounded-pill">
                            Back to Orders
                        </Link>
                    </div>
                </div>
